...
n_cores <- max(1L, as.integer(Sys.getenv("LSB_DJOB_NUMPROC", unset = "1")) - 1L)
...
write_csv(LR_auc_results,
            paste0("Data/AUC_table_gene_holdout_LR_models_", date, ".csv"))
...
write_csv(variant_count_DF,
            paste0("Data/Variant_counts_per_gene_", date, ".csv"))
